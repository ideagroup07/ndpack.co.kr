                  ...
                  <div className="lg:col-span-12 xl:col-span-7 space-y-6 text-gray-800 text-base font-medium">
                    ...
                    <div className="leading-relaxed space-y-5 font-sans text-gray-700">
                      <p className="text-base md:text-lg">
                        포장재는 단순히 제품을 담는 포장이 아닙니다. 제품의 신선도와 품질을 지키고, 생산자의 정성과 가치를 소비자에게 안전하게 전달하는 중요한 역할을 합니다.
                      </p>
                      <p className="text-base md:text-lg">
                        엔디팩은 1990년 창립 이후 비닐팩, 파우치 가공, 기능성 필름 합지, 그라비어 인쇄 분야에 집중해 왔습니다. 한 분야에 꾸준히 전념하며 쌓아온 경험과 기술력을 바탕으로, 고객사의 제품에 맞는 안정적인 포장재를 생산하고 있습니다.
                      </p>
                      <p className="text-base md:text-lg">
                        최근에는 성서공단 통합 본사를 중심으로 생산 설비와 공정 관리 체계를 강화했습니다. 청결한 생산 환경과 정밀한 품질 관리 시스템을 통해 식품, 영유아 제품, 위생용품, 산업용 포장재 등 다양한 분야의 제품을 안전하게 제작하고 있습니다. 엔디팩은 앞으로도 고객사의 입장에서 생각하고 움직이겠습니다. 합리적인 원가, 안정적인 품질, 정확한 납기를 바탕으로 고객사의 성장에 힘이 되는 믿을 수 있는 파트너가 되겠습니다.
                      </p>
                      <p className="text-base md:text-lg">
                        감사합니다.
                      </p>
