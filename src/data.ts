...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  description: '1990년 창립 이후 비닐팩, 파우치 가공 및 NY, PET, OPP 기능성 특수 포장재 합지 제조 역량을 바탕으로 최고의 가치를 선사하는 New Developing Pack (엔디팩) 공식 웹사이트입니다.',
  ...
  instagram: 'https://instagram.com/ndpack',
  kakaotalk: 'https://pf.kakao.com/_ndpack',
